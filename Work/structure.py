...
class downright(QWidget):#右下角分类结果展示
    def __init__(self):
...
class downright_reg(QWidget):#右下角回归结果展示
    def __init__(self):
        super(downright_reg, self).__init__()
        self.initUI()
    def initUI(self):
        self.hbox = QHBoxLayout()
        self.hbox1 = QHBoxLayout()
...
class topright(QWidget):#右上角测井曲线显示
    def __init__(self):
    ...
    def initUI(self):
        ...
        # self.show=ShowImage_TopRight.ApplicationWindow()
        # print(self.Topleft.listwidget_train.currentItem().text())
        # show.initUI(self.Topleft.listwidget_train.currentItem().text())
        # self.downleft=downleft()
        # if(self.downleft.data_train != None):
        #     ShowImage_TopRight.ApplicationWindow().initUI(self.data_train)
        self.stack1 = ShowImage_TopRight.ApplicationWindow()
        self.stack2 = ShowImage_TopRight.ApplicationWindow()#QWidget()
        self.stack3 = ShowImage_TopRight.ApplicationWindow()#QWidget()
        self.tab1UI()
        self.tab2UI()
        self.tab3UI()
...
class topleft(QWidget):#左上文件选择
    ...
    def tree_clicked(self,Qmodelidx):
        ...
        print("sssssssssss"+self.filePath)
